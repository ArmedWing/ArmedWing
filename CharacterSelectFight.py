...
if unit.attack > randPlayerCharacter.attack:           ### Checks if the User input's Character attack is higher than the Computer's random one
    print("You win")
elif unit.attack == randPlayerCharacter.attack:        ### Checks if the User input's Character attack is equal to the Computer's random one
    print("It is a draw!")
else:
    print("You lose")
